...
//            new GeneratedPalette(1L, "#ff0000", "rgb(225,0,0)", "hsl(0,100,50)", "hsv(0,100,50)", "Bright Red", "cmyk(0,100,100,0)", "#000000"),
//            new GeneratedPalette(2L, "#00ff00", "rgb(0,255,0)", "hsl(0,120,50)", "hsv(0,120,50)", "Bright Green", "cmyk(100,0,100,0)", "#000000"),
//            new GeneratedPalette(3L, "#0000ff", "rgb(0,0,255)", "hsl(0,240,50)", "hsv(0,240,50)", "Bright Blue", "cmyk(100,100,0,0)", "#000000")
//    );
//
//    @GetMapping
...
//    }
//
//    @GetMapping("/same-seeds")
//    public List<GeneratedPalette> getSameSeeds() {
//        return generatedPalettes.stream()
//                .filter(GeneratedPalette::getSeedHexCode) //Fix error later
//                .toList();
//    }
//
//}
